...
# (automatic pitch - cannot be corrected, a correct pitch is important
# for quality, see script timingAndPitchTransfer_manualPitch.praat)
# ---------------------------------------------------------------------------
# Create files with these names (4 files):
...
selectObject: sndt
man = To Manipulation: 0.01, 75, 1000
